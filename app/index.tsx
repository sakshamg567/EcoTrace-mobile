...
export default function Index() {
  ...
  return (
    <SafeAreaView className="bg-green-50 h-screen-safe-offset-28 ">
      <StatusBar style="dark" backgroundColor="#f0fdf4" />
      <View className="flex-1 justify-around p-6 min-h-[85vh]">
        ...
        <Image 
          source={images.earth}
          className="w-[320px] -z-20 absolute top-16 "
          resizeMode="contain"
        />
        <View className="space-y-6 mt-36">
          <Text className="text-lg mb-5 font-plight text-green-800 text-center">Ready to make a difference?</Text>
        ...
        <Text className="text-center text-green-600 mt-6 font-plight text-xs">
